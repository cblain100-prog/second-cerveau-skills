...
4. Liste `.claude/skills/` (vrais dossiers et liens). Ne touche à aucun skill. Note la présence de `/save`.
...
6. **Skills** : déplace les vrais dossiers de `.claude/skills/` vers `Skills/` (ou `1 Terrains/<Business>/Skills/` pour un skill propre au business : facturation, propositions…), puis lance `link-skills.sh`.
